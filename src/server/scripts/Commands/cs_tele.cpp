...
public:
    ...
    ChatCommand* GetCommands() const override
    {
        static ChatCommand teleCommandTable[] =
        {
            ...
            { "delete",   rbac::RBAC_PERM_COMMAND_TELE_DEL,    true, &HandleTeleDelCommand,   "", NULL },
            { "portplayer",  rbac::RBAC_PERM_COMMAND_TELE_NAME,   true, &HandleTeleNameCommand,  "", NULL },
            { "portus", rbac::RBAC_PERM_COMMAND_TELE_GROUP, false, &HandleTeleGroupCommand, "", NULL },
            { "port",  rbac::RBAC_PERM_COMMAND_TELE,       false, &HandleTeleCommand,      "", NULL },
            { NULL,    0,                            false, NULL,                    "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "recall", rbac::RBAC_PERM_COMMAND_TELE, false, NULL, "", teleCommandTable },
            { NULL,   0,                      false, NULL, "", NULL }
        };
        return commandTable;
    }
