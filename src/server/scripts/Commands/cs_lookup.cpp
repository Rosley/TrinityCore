...
public:
    ...
    ChatCommand* GetCommands() const override
    {
        ...
        static ChatCommand lookupCommandTable[] =
        {
			...
			{ "displayid", rbac::RBAC_PERM_COMMAND_LOOKUP_DISPLAYID, true, &HandleLookupCreatureDisplayCommand, "", NULL },
            ...
            { "port",     rbac::RBAC_PERM_COMMAND_LOOKUP_TELE,     true, &HandleLookupTeleCommand,     "", NULL },
	...
	static bool HandleLookupCreatureDisplayCommand(ChatHandler* handler, char const* args)
	{
		if (!*args)
			return false;
