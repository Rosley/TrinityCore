...
enum RBACPermissions
{
	...
	RBAC_PERM_COMMAND_GOBJECT_SELECT                         = 779,
	...
	RBAC_PERM_COMMAND_WORLD_CHAT                             = 778,
	RBAC_PERM_COMMAND_DISABLE_REMOVE_DISPLAYID               = 780,
	RBAC_PERM_COMMAND_DISABLE_REMOVE_ZONE                    = 781,
	RBAC_PERM_COMMAND_DISABLE_REMOVE_NPC                     = 782,
	RBAC_PERM_COMMAND_DISABLE_REMOVE_ITEM                    = 783,
	RBAC_PERM_COMMAND_DISABLE_REMOVE_GOBJECT                 = 784,
	RBAC_PERM_COMMAND_DISABLE_ADD_DISPLAYID                  = 785,
	RBAC_PERM_COMMAND_DISABLE_ADD_ZONE                       = 786,
	RBAC_PERM_COMMAND_DISABLE_ADD_NPC                        = 787,
	RBAC_PERM_COMMAND_DISABLE_ADD_ITEM                       = 788,
	RBAC_PERM_COMMAND_DISABLE_ADD_GOBJECT                    = 789,
	RBAC_PERM_COMMAND_LOOKUP_DISPLAYID                       = 790,
	RBAC_PERM_COMMAND_TOGGLE                                 = 791,
	RBAC_PERM_COMMAND_TOGGLE_APPEAR                          = 792,
	RBAC_PERM_COMMAND_TOGGLE_SUMMON                          = 793,
	RBAC_PERM_COMMAND_TOGGLE_MODIFY                          = 794,
	RBAC_PERM_COMMAND_NUDGE                                  = 795,
	RBAC_PERM_COMMAND_NUDGEX                                 = 796,
